...
const NavBar = () => {
    ...
    return (
        <div className='flex justify-between items-center w-full h-20 px-4 text-white bg-black fixed'>
            <div>
                <h1 className='text-5xl font ml-2'>PortFolio</h1>
            </div>
            ...
            <ul className='hidden md:flex'>
                ...
                {
                    links.map(({id, link}) => (
                        <li key={id} className='px-4 cursor-pointer capitalize font-heavy text-black-500 hover:scale-105 hover:text-white duration-200'><Link to={link} smooth duration={500}>{link}</Link></li>
                    ))
                }
